...
flu_dif_s = artrans.wge(flu, phi.tr = (c(rep(0,51), 1))) # takes out 51 week seasonality 
...
ljung.wge(est_arma$res) #pval 0.1914016
ljung.wge(est_arma$res, K=48)  #pval 0.5115472
...
Above the ASE of the model is shown followed by the ASE of a naive model. These are followed by the difference between the two. 
